...
/**
 * English language pack for mod_viewer3d
 *
...
$string['stlfile'] = 'STL File';
$string['stlfile_help'] = 'Upload an STL file to be displayed in the 3D viewer.';
$string['viewer3d:addinstance'] = 'Add a new 3D Viewer';
$string['viewer3d:download'] = 'Download 3D model';
$string['viewer3d:view'] = 'View 3D model';
